...
public class Scale_Matrix : Ability {
    ...
    public override bool trigger()
    {
        ...
        // Add scaling effect
        character.graphics.addTimedEffectFor(graphic.Scale, abilityName);

        // Increase AD
        combat.stats.effects.addTimedEffectFor(attribute.AD, abilityName);

        return true;
    }

    public Func<Timed_Effect<Graphical>> make_scaleMatrix_Graphic(GameObject caster)
    {
    ...
    public static Timed_Effect<Effect_Management.Attribute> scaleMatrix_attribute()
    {
    ...
    public override void registerEffects()
    {
        ...
        Effect_Management.Graphics_Manager.timedEffects.Add(abilityName, make_scaleMatrix_Graphic(caster));
    }
}
